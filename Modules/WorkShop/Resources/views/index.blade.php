        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>WorkShop Table <small> all workshops </small></h2>
                                        ...
                                        @foreach($rows as $row)
                                            ...
                                            <td class=" ">
                                                <form action="#" method="post">
                                                    <a href="{{ route('workshops.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
