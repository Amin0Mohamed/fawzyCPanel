        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Create New in {{ $program->date }}<small>new main program</small></h2>
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" action="{{ route('main.programs.store') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="session_name" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="number" id="name" name="session_number" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="name" name="presenters" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6 col-xs-12 input-group date" id="myDatepicker3" style="padding-right: 10px;padding-left: 10px; float: left;">
                                            <input name="start_time" type="text" class="form-control col-md-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 input-group date" id="myDatepicker4" style="padding-right: 18px;padding-left: 5px; float: left;" >
                                            <input name="end_time" type="text" class="form-control col-md-3 col-xs-12">
                                            <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                        </div>
