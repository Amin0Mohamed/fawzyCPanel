        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Main Programs in  Chairs <a href="{{ route('chairs.create') }}" class="btn btn-dark btn-sm"> <i class="fa fa-plus"></i> Add </a></h2>
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td class=" ">
                                                    <form action="#" method="post">
                                                        <a href="{{ route('chairs.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
