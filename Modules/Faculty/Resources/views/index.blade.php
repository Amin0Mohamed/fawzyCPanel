        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Faculty Table <small> all faculties </small></h2>
                                ...
                                <table id="myTable" class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        @foreach($rows as $row)
                                            ...
                                            <td class=" ">{!! substr($row->description,0,20) !!}</td>
                                            <td class=" ">
                                                <form action="#" method="post">
                                                    <a href="{{ route('faculties.edit',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
